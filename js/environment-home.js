const colorEffects = (() => {
    ...
    function bGColors(innerColor, outerColor){
        deg += 0.2;
    ...
    function colorFade(){
        ...
        bGColors(colorLerp(babyBlue, transBabyBlue, deltaTime), colorLerp(transBabyBlue, babyBlue, deltaTime));
    }
...
setInterval(colorEffects.updateEnvironment, 33);//gameboardColorEffects.interval());
